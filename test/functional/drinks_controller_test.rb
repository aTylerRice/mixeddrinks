...
class DrinksControllerTest < ActionController::TestCase
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post :create, drink: { category: @drink.category, directions: @drink.directions, name: @drink.name }
    end
  ...
  test "should update drink" do
    put :update, id: @drink, drink: { category: @drink.category, directions: @drink.directions, name: @drink.name }
    assert_redirected_to drink_path(assigns(:drink))
  end
